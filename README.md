...
- **Включение** - используется в случае, когда вы указываете связь между понятием и каждым перечисленным элементом. 
...
Здесь заметно, что понятия, которые описывают *образованную кибернетическую систему* имеют связь с понятием *образованная кибернетическая система*. Также важно заметить, что при *отношении включения* не используются фигурные скобки: {}
...
=> уточнение*/пояснение*/примечание*:

[текст]

Обратите внимание на то, что в данном случае используются квадратные скобки и внутри текст. Это объясняется тем, что, когда мы используем [], то используем занесенную информацию как комментарий, то есть отдельным понятием она не является. В отличие от понятного нами отношения *уточнения/пояснения*, примечание используется для того, чтобы обозначить какое-нибудь "исключение из правил" при описании выбранного вами понятия.
...
\scnheader{название понятия} - название вашего понятия 

\scnidtf{определение} - определение или другое название ( := )

\scnitem{какое-либо понятие} - для добавления мячика
**ПРИМЕР:**
___

___

\scntext{аннотация/уточнение/примечание/пояснение}{текст} - можно использовать для добавления ссылки, а также аннотации, цитаты, пояснения и уточнения, так как, как вы заметили, текст расположен в [] скобках. В первых фигурных скобках название разбиения, во вторых - текст.
...
**Для указания декомпозиции, но может быть и другое разбиение. Во вторых {} нужно указать название, например, декомпозиция:**
...
\scnrelfrom{обощенная декомпозиция/разбиение/декомпозиция}{какое-нибудь слово(слова) в единственном числе и именительном падеже}
