...
\begin{scnrelfromlist}{библиографическая ссылка} & \end{scnrelfromlist}  - В основном используется для указания библиографических ссылок, но вы так же можете использовать это и для указания авторов, библиографических ссылок и ключевых слов.
...
\begin{scnsubdividing} & \end{scnsubdividing} - используется для указания разбиения. 

\begin{scnrelfromset}{} & \end{scnrelfromset} - используется для указания декомпозиции или обобщенной декомпозиции, но может быть и другое разбиение. Во вторых {} нужно указать название, например, декомпозиция.
